...
{
  const auto trapdoorSectorX = gsl::narrow_cast<int>(m_state.location.position.X / core::SectorSize);
  const auto trapdoorSectorZ = gsl::narrow_cast<int>(m_state.location.position.Z / core::SectorSize);
  const auto posSectorX = gsl::narrow_cast<int>(pos.X / core::SectorSize);
  const auto posSectorZ = gsl::narrow_cast<int>(pos.Z / core::SectorSize);
